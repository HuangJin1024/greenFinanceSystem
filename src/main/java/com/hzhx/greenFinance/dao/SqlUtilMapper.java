...
public interface SqlUtilMapper {
	...
	@Select("select fileNameIndex from greenfin_log where reportBank = #{reportBank} and requestDate = #{requestDate} and requestType = #{requestType} and resultCode ='0' order by fileNameIndex desc limit 1")
